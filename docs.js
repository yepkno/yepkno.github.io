...
window.DOCS = [
  ...
  /* ========================================================================
     ...
     扩展字段说明：
       ...
       cost    费用构成：{ 类别: 金额 }（元）
       plan    逐日行程表：[["D1","路线","住宿","里程km"], ...]
     注：以下 3 篇为**框架示例数据**，正式内容待录入后替换。
     ======================================================================== */
  {
    title: "川西环线 · 稻城亚丁",
    category: "旅游攻略",
    ...
    `,
    pts: [
      { d: 1, n: "成都", lon: 104.07, lat: 30.67, stay: "成都" },
      { d: 2, n: "康定", lon: 101.96, lat: 30.05, stay: null },
      { d: 2, n: "折多山", lon: 101.80, lat: 30.05, stay: "新都桥" },
      { d: 3, n: "稻城亚丁", lon: 100.30, lat: 28.43, stay: "亚丁村" },
      { d: 4, n: "丹巴", lon: 101.89, lat: 30.88, stay: "丹巴" }
    ],
  ...
  },
  {
    ...
    `,
    pts: [
      { d: 1, n: "西宁", lon: 101.78, lat: 36.62, stay: "西宁" },
      { d: 2, n: "青海湖", lon: 100.20, lat: 36.90, stay: "黑马河" },
      { d: 3, n: "茶卡盐湖", lon: 99.08, lat: 36.78, stay: "德令哈" },
      { d: 4, n: "大柴旦", lon: 95.30, lat: 37.85, stay: "大柴旦" },
      { d: 6, n: "敦煌", lon: 94.66, lat: 40.14, stay: "敦煌" }
    ],
  ...
  },
  {
    ...
    `,
    pts: [
      { d: 1, n: "昆明", lon: 102.83, lat: 24.88, stay: "昆明" },
      { d: 3, n: "大理", lon: 100.23, lat: 25.59, stay: "大理" },
      { d: 5, n: "沙溪", lon: 99.85, lat: 26.32, stay: "沙溪" },
      { d: 7, n: "丽江", lon: 100.23, lat: 26.86, stay: "丽江" },
      { d: 9, n: "泸沽湖", lon: 100.78, lat: 27.70, stay: "泸沽湖" }
    ],
