...
<p>预算口径：4 人、1 台 5 座<strong>插电混动 SUV</strong>、7 天租期（提前一周下单）、2 间双人房（经济型）；餐饮按「<strong>午餐从简、晚餐吃好</strong>」；国庆免费时段的高速通行费按 ¥0 计。</p>
<div class="callout"><strong>合计约 ¥10,900–13,300（4 人总额）</strong>，人均约 ¥2,700–3,300。不含购物、骑马、游船、氧气、防寒服、保险及意外延误住宿。<br>本轮按「<strong>插混车 + 住宿降一档 + 午餐从简</strong>」重算，相比上一版约省 ¥3,600 —— 降幅主要来自租车与油费。</div>
<table>
  ...
  <tr><td class="k">油费</td><td>¥1,300–1,700</td><td>插混综合约 5 升 / 100 公里 + 沿途补电（含电费）；全程约 3,300–3,500 公里，云南油价约 7.5–8 元 / 升</td></tr>
  <tr><td class="k">租车</td><td>¥2,450–3,500</td><td>5 座<strong>插混</strong> SUV、<strong>提前一周订</strong>的行情 ¥350–500 / 天 × 7 天；属交通，不计入门票</td></tr>
...
<p>这段路要翻白马雪山、走高原山路，租车是整个预算里最容易算错、也最该提前动手的一项。<strong>本轮把车型换成插电混动 SUV</strong>：租金不比燃油 SUV 贵，油费却能砍掉近一半。</p>
...
<table>
  ...
  <tr><td class="k">租金（淡季）</td><td>¥200–350 / 天</td><td>插混 SUV 平日价</td></tr>
...
<h3>插混车怎么用最省</h3>
<ul>
  <li><strong>满油满电出发</strong>：插混 SUV 满油满电的实际综合续航约 1,100–1,300 公里（高速为主）—— <strong>云南环线这一段（大理 → 飞来寺 → 大理，约 1,200 公里）全程只需加一次油</strong>。</li>
...
`,
    ...
    people: 4,
    cost: { "住宿": 2700, "门票": 2050, "餐饮": 2500, "油费": 1500, "租车": 2900, "停车": 300 },
    plan: [
