...
window.DOCS = [
  ...
  /* ========================================================================
     ⭐ 知识文库 · 四个分类的**示例文档**（2026-09-21 批十七新增；同日 rule 一格改为「年度修习」）
        ⭐ 同日二次调整：原《馆藏规则 · 入馆须知》迁入 archive 格（改名「取阅须知」）；
           rule 格换成《年度修习 · 2026》学习计划（骨架，内容待填）。
        —— 用户："四个选项里灰色得添加示例进去"。原来只有 tech 一篇，其余三卡点不开。
        ⚠️ 这三篇是**示例文本**：可以直接改标题/正文，或整块删掉（删掉后对应入口会自动变灰，
           `knSyncPortal()` 按"该 shelf 有没有文档"决定启用与否）。
        ⚠️ 措辞口径（别改坏）：原件说的是**文档**；本站**不制作、不修改、不存储任何软件文件与安装包**，
           软件类资源不在站内提供（见站点免责声明）。
     ===================================================================== */
  {
    title: "年度修习 · 2026",
    category: "知识文档",
    shelf: "rule",
    summary: "今年打算学完、读完、做完的东西都登在这本簿子上 —— 目标、节拍、进度，以及没做到的部分。",
    date: "2026-09-21",
    tags: ["年度修习", "学习计划"],
    content: `
      <div class="callout">📌 这是<strong>今年的修习登记簿</strong>。写在上面的事不一定都能做到，但写下来，至少知道欠了自己什么。</div>
      <hr>
      <h2>一 · 今年想拿下的</h2>
      <p>（待填）写法尽量<strong>能验收</strong> —— 不是"学 Python"，而是"能用 Python 写完一个能跑通的采集脚本"。</p>
      <ul>
        <li>…</li>
      </ul>
      <h2>二 · 怎么排</h2>
      <p>（待填）把上面摊到四个季度里，每个季度只留一件"必须完成"，其余的算加分项。</p>
      <hr>
      <h2>三 · 进度</h2>
      <p>（待填）每推进一步就挪到这里，写一句"到什么程度了" —— 半成品也写。</p>
      <h2>四 · 每月一句</h2>
      <p>（待填）月末写一句实话：这个月真正推进了什么，什么被搁下了，为什么。</p>
      <hr>
      <p class="warn">⚠️ 本页目前是<strong>骨架</strong>：结构先立在这里，内容待填。</p>
    `
  },
  {
    title: "取阅须知",
    category: "知识文档",
    shelf: "archive",
    summary: "这座文库的取阅约定：怎么找、怎么引、原件怎么申请，以及我们希望你把什么带走。",
    date: "2026-09-21",
    tags: ["馆藏", "使用指南"],
    content: `
      <div class="callout">📌 这里不是一座需要登记的图书馆 —— 你推门进来，坐下读就好。下面几条只是让这座文库保持体面的约定。</div>
      <hr>
      <h2>一 · 关于取阅</h2>
      <p>文库内的所有文档<strong>都可以直接阅读</strong>，不需要借阅证，也没有归还期限。左侧的目录会随文档增减自动更新；如果你不知道从哪读起，首页的「随机一读」会替你翻一篇出来。</p>
      <h2>二 · 关于安静</h2>
      <p>文库没有声音，也不需要你保持安静。这里唯一被建议"轻一点"的事情是：<strong>读到不同意的观点时，先读完再判断</strong>。</p>
      <h2>三 · 关于引用</h2>
      <p>这里的文档大多整理自公开资料、教程与个人笔记。把它们带走、转述、用在你的项目里都没问题；如果方便，<strong>请把出处一并带上</strong>——不是规矩，是对原作者的体面。</p>
      <h2>四 · 关于原件</h2>
      <p>技术文库与人文文库的部分文档带有<strong>原件</strong>（本文档的完整版、配图版或可下载的文档摘录），统一收在「<strong>馆藏原件</strong>」那一格里。原件都是<strong>文档</strong>，可以直接取用；<strong>软件类资源不在本站存储</strong>，具体见站点的免责声明。</p>
      <h2>五 · 关于这座文库的边界</h2>
      <p>文库只做两件事：<strong>整理</strong>与<strong>指路</strong>。它不替你判断什么值得学，也不保证每一篇都仍然有效——技术文档尤其如此，读到与现状不符的地方，以你手上工具的官方文档为准。</p>
      <hr>
      <p class="warn">⚠️ 本页是<strong>示例文本</strong>，条目可随时增删。真正需要遵守的只有站点底部的免责声明。</p>
    `
  },
  /* ══════════════════════════════════════════════════════════════════════════
     人文文库 · 五部分（2026-09-22 用户：\"人文文库也一样，分五个部分，
     历史、社科、财经、文学、哲学\"）
     ⚠️ 归类靠 **`sub`** 字段：hist 历史 ｜ soc 社科 ｜ fin 财经 ｜ lit 文学 ｜ phi 哲学
        （换过 key 会让入口卡上的篇数归零 —— 改 key 要同步 `KTH_SHELVES.humanities`）
     ⚠️ 语气与技术文库**刻意不同**：技术答\"怎么做\"，人文答\"怎么看待\" ——
        所以这里**不写步骤、不写命令**，只把一件事拆开摆出来。
     ══════════════════════════════════════════════════════════════════════════ */
  {
    title: "我们为什么会为一本书流泪",
    category: "知识文档",
    shelf: "humanities",
    sub: "lit",
    summary: "阅读是唯一一种「别人的经验能直接变成你的经验」的通道 —— 一篇关于读、共情与承受的短文。",
    date: "2026-09-22",
    tags: ["文学", "阅读", "共情"],
    content: `
      <h2>一</h2>
      <p>我们为一本书流泪，通常不是因为书里那个人死了，而是因为<strong>在他死之前，我们已经替他把话在心里说完了一遍</strong>。</p>
      <p>阅读最奇特的地方在于：它是唯一一种\"别人的经验能直接变成你的经验\"的技术。电影给你看、音乐给你听，只有文字要求你先在脑子里把那些画面<strong>自己搭一遍</strong>——而凡是亲手搭过的东西，都会留下痕迹。</p>
      <h2>二</h2>
      <p>所以读得越多的人，越容易在现实里被击中。这不是脆弱，这是<strong>经验被扩容的代价</strong>：你的心里多了很多本不属于你、但你已经付过同情心的人生。</p>
      <p>文学从来不负责让人变好。它负责的是让人变得<strong>更能承受</strong>——承受别人与你不同，承受世界不按你的道理运行，承受有些问题没有答案。</p>
      <h2>三</h2>
      <p>这也是这个文库为什么把人文单独放在一格的原因：</p>
      <ul>
        <li>技术文档回答\"<strong>怎么做</strong>\"，它可以被替换、被更新、被证伪；</li>
        <li>人文文章回答\"<strong>怎么看待</strong>\"，它不能被替换，只能被反复重读。</li>
      </ul>
      <p>前者让你把事做成，后者让你在做成之后，还愿意继续做下去。</p>
    `
  },
  {
    title: "馆藏原件总目",
    category: "知识文档",
    shelf: "archive",
    summary: "技术文库与人文文库的文档原件清单：包含什么、怎么取用、以及本站不提供什么。",
    date: "2026-09-21",
    tags: ["馆藏", "原件", "下载"],
    content: `
      <div class="callout">📌 原件＝<strong>文档本身</strong>（完整版、配图版、可下载的摘录）。它们是文库的"底稿"，正文页里被裁掉的部分都在这里。</div>
      <hr>
      <h2>一 · 原件与正文的关系</h2>
      <p>正文页为了方便阅读，会把长文档拆开、重排、去掉重复截图。<strong>原件保留了原始的面貌</strong>：章节顺序、完整图表、以及正文里只提了一句的细节。</p>
      <p>如果你只是想快速了解，读正文就够；如果你要照着手做一遍（例如配置开发环境），建议对着原件走。</p>
      <h2>二 · 目前的藏品</h2>
      <ul>
        <li><strong>技术文库</strong> —— OpenCode 使用教程（零基础版）：完整教程文档，含各步骤截图。</li>
        <li><strong>人文文库</strong> —— 试读样章的完整稿（待正式文章上线后一并收录）。</li>
        <li><strong>其他</strong> —— 随文档更新陆续入库，本页会同步列出。</li>
      </ul>
      <h2>三 · 怎么取用</h2>
      <p>原件是<strong>文档</strong>，可以直接取用：在对应正文页末尾的原件入口进入；如果还没有链接，说明该原件尚未整理完，可以联系站长说明你要哪一份。</p>
      <p class="warn">⚠️ <strong>软件类资源（安装包、镜像等）不在本站存储</strong>。站内只放文档原件；软件类资源的获取方式见站点免责声明。</p>
      <h2>四 · 一点说明</h2>
      <p>文库里的原件多来自公开渠道的整理与个人转写，仅供学习交流。如果某一份涉及你的权益，请按站点的侵权投诉指引联系，会尽快处理。</p>
      <hr>
      <p class="warn">⚠️ 本页为<strong>示例文本</strong>，藏品清单会随文库增长而改写。</p>
    `
  },
...
<table>
  ...
  <tr><td class="k">D0</td><td>重庆 → 大理（自有天然气车；不计入 5 日旅游，纯赶路）</td></tr>
  ...
  <tr><td class="k">D6</td><td>大理 → 重庆（自有车；还车后返程）</td></tr>
</table>
...
<p>D0 不计入 5 日旅游，目标是把车和人送到大理，让 D1 从大理完整开始。<strong>这一段开的是项目自有车辆（烧天然气，费用由项目承担，不计入本页预算）</strong>，D1 到大理后才取租车。<span class="warn">若只有一位驾驶员，不建议为了赶到大理而连续夜间长途驾驶。</span></p>
<table>
  <tr><th>项目</th><th>内容</th></tr>
  <tr><td class="k">出发</td><td>下午从重庆出发</td></tr>
  <tr><td class="k">终点</td><td>大理</td></tr>
  <tr><td class="k">住宿</td><td>大理古城外围经济型客栈 / 快捷酒店</td></tr>
  <tr><td class="k">房费</td><td>约 ¥140–210 / 晚（单间）；4 人 2 间合计约 <strong>¥280–420 / 晚</strong></td></tr>
...
<h3>住宿</h3>
<p>大理古城外围经济型客栈 / 快捷酒店｜约 ¥280–420 / 晚（2 间房）· 自驾友好、有停车位；选古城外围比古城内便宜一大截，D0 和 D1 可以连续入住。</p>
...
<h3>吃什么</h3>
<p>午餐：古城外围面馆 / 米线，简餐为主，约 ¥80–140 / 4 人。</p>
<p>晚餐：<strong>花花色私房菜</strong>（丽江古城五一街一带，云南地方菜），约 ¥240–360 / 4 人 —— 当天正餐放这一顿。</p>
<h3>住宿</h3>
<p>丽江城区 / 束河外围经济型酒店｜约 ¥340–520 / 晚（2 间房）· 自驾出城方便；束河古镇内的客栈旺季贵、停车也不方便。</p>
...
<h3>吃什么</h3>
<p>午餐：虎跳峡镇简餐，以快、热量够为主，约 ¥80–140 / 4 人。</p>
<p>晚餐：<strong>瞻巴拉藏餐吧</strong>（香格里拉市区，可尝牦牛肉、藏式面食、酥油茶），约 ¥240–360 / 4 人 —— 当天正餐放这一顿。</p>
<h3>住宿</h3>
<p>香格里拉市区经济型酒店 / 客栈｜约 ¥320–480 / 晚（2 间房）· 海拔 3,280 米，入住时务必确认停车、供暖与是否有制氧机。</p>
...
<h3>吃什么</h3>
<p>午餐：德钦县城家常菜，简餐为主，重点是补给和休息，约 ¥80–140 / 4 人。</p>
<p>晚餐：<strong>梅里往事</strong>（飞来寺 / 德钦方向备选），山里营业状态以当天为准，约 ¥240–360 / 4 人。</p>
<h3>住宿</h3>
<p>飞来寺经济型客栈的雪山观景房｜约 ¥480–880 / 晚（2 间房）· <span class="warn">务必选择「雪山正面观景房」</span> —— 这是全程最不该省的一晚，便宜的房型常常只剩侧面或看不到主峰。</p>
<p>4 人住宿默认 2 间双人房，D0–D5 共 6 晚；本页预算按<strong>经济型连锁 / 客栈</strong>口径（相比精品度假酒店降一档），若选家庭房 / 四人套房，通常还能再低一些。</p>
...
<h3>吃什么</h3>
<p>午餐：奔子栏 / 香格里拉沿线简餐，约 ¥80–140 / 4 人，重点是快速补给。</p>
<p>回大理晚餐：<strong>云禾壹海景庄园餐厅</strong>（若抵达较早，大理古城南门附近），约 ¥300–420 / 4 人；太晚就近解决。</p>
<h3>住宿</h3>
<p>大理古城外围经济型客栈 / 快捷酒店｜约 ¥280–420 / 晚（2 间房）· 回程后不再折腾换酒店。</p>

<h2 id="tour-budget">4 人 1 车 · 全程预算</h2>
<p>预算口径：4 人、<strong>云南段租 1 台 5 座插电混动 SUV（D1 大理取车 → D5 大理还车，共 5 天）</strong>、2 间双人房（经济型）；餐饮按「<strong>午餐从简、晚餐吃好</strong>」。<strong>重庆往返段开项目自有天然气车，气费与过路费由项目承担，不进本预算</strong>；云南段租车完全落在国庆免费时段内，高速通行费按 ¥0 计。</p>
<div class="callout"><strong>合计约 ¥9,300–11,300（4 人总额）</strong>，人均约 ¥2,300–2,800。不含购物、骑马、游船、氧气、防寒服、保险及意外延误住宿，也不含重庆往返段（自有车、项目承担）。<br>本轮按「<strong>只租云南段 5 天 + 插混车 + 住宿降一档 + 午餐从简</strong>」重算 —— 租车与油费都只算云南段，是相比上一版降幅最大的两项。</div>
<table>
  <tr><th>项目</th><th>预算</th><th>说明</th></tr>
  <tr><td class="k">住宿</td><td>¥2,200–3,400</td><td>D0–D5 共 6 晚、2 间房，按<strong>经济型连锁 / 客栈</strong>口径；<span class="warn">国庆旺季普遍上浮 30–50%，建议按上限准备</span></td></tr>
  <tr><td class="k">门票</td><td>¥1,912–2,192</td><td>4 人合计，含黑龙潭维护费、木府、万古楼、虎跳峡、<strong>普达措</strong>、<strong>松赞林寺</strong>、梅里组合票</td></tr>
  <tr><td class="k">餐饮</td><td>¥2,200–2,900</td><td>4 人；<strong>午餐从简（简餐 / 面食 / 路餐）、晚餐吃好</strong>，早餐多为住宿含早</td></tr>
  <tr><td class="k">油费</td><td>¥500–700</td><td><strong>只算云南环线段约 1,200 公里</strong>（重庆往返用自有天然气车，不计）；插混综合约 5 升 / 100 公里 —— 约等于<strong>一箱油</strong>，另加沿途补电的费用</td></tr>
  <tr><td class="k">租车</td><td>¥1,750–2,500</td><td>5 座<strong>插混</strong> SUV、<strong>提前一周订</strong>的行情 ¥350–500 / 天 × <strong>5 天</strong>（D1 大理取、D5 大理还；同城取还，无异地还车费）；<strong>属交通，不计入门票</strong></td></tr>
  <tr><td class="k">高速</td><td>¥0</td><td>重庆往返段由项目承担；云南段租车期完全落在国庆免费时段内</td></tr>
...
<h3>国庆高速免费怎么算</h3>
<p>2026 年 10 月 1 日 0:00 至 10 月 7 日 24:00，7 座及以下小型客车免收通行费；<strong>是否免费按车辆驶离高速出口收费站的时间判断</strong>。本行程的租车完全落在免费时段内（D1 取车 → D5 还车），云南段高速通行费按 ¥0 预算；重庆往返段由项目承担，同样不进本预算。</p>

<h2 id="tour-rent">租车怎么订最划算</h2>
<p>这段路要翻白马雪山、走高原山路，租车是整个预算里最容易算错、也最该提前动手的一项。<strong>只租云南段 5 天</strong>（D1 大理取、D5 大理还），车型用<strong>插电混动 SUV</strong>：租金不比燃油 SUV 贵，油费还能砍掉近一半。</p>
<div class="callout"><strong>先说结论：仍然建议直接选「不限里程」套餐。</strong>租车只算云南段（大理 → 飞来寺 → 大理，约 <strong>1,200 公里 / 5 天</strong>，日均约 240 公里），但标准套餐通常限 <strong>200 公里 / 天</strong>，5 天共 1,000 公里，还是会超约 200 公里 —— 按 <strong>1–2 元 / 公里</strong>另收就是 200–400 元；而不限里程套餐一般只贵约 <strong>50 元 / 天（5 天约 250 元）</strong>，基本打平，还不用担心临时改道。<strong>若打算顺路加泸沽湖、虎跳峡徒步之类，就更是必选。</strong></div>
<table>
  <tr><th>项目</th><th>行情</th><th>说明</th></tr>
  <tr><td class="k">车型</td><td>5 座<strong>插电混动</strong> SUV</td><td>宋 PLUS DM-i / 唐 DM-i 一类，租车平台保有量大；山路 + 高原，轿车通过性差，不必上硬派越野</td></tr>
  <tr><td class="k">租金（淡季）</td><td>¥200–350 / 天</td><td>插混 SUV 平日价（本行程用不到，仅作对比）</td></tr>
  <tr><td class="k">租金（国庆）</td><td><strong>¥350–500 / 天</strong></td><td>节假日上浮 30–50%；同档燃油 SUV 要 ¥450–700，插混反而更便宜</td></tr>
  <tr><td class="k">提前多久订</td><td>越早越好</td><td>提前 30 天比节前一周<strong>便宜约一半</strong>；最佳窗口是提前 30–45 天（直营平台 8 月中旬就开放国庆预订）</td></tr>
  <tr><td class="k">取车时间</td><td>10 月 1 日（D1）</td><td>大理取车、5 天后大理还车。<span class="warn">10/1 正是假期价格最高的时候</span>，更要提前下单锁价</td></tr>
...
<h3>插混车怎么用最省</h3>
<ul>
  <li><strong>满油满电出发，全程只需加一次油</strong>：插混 SUV 满油满电的实际综合续航约 1,100–1,300 公里，而<strong>云南环线整段只有约 1,200 公里</strong>（大理 → 飞来寺 → 大理）—— 取车时满油满电，<strong>中途加一次油就够跑完，还车时也容易凑回满油状态</strong>。</li>
  <li><strong>每晚补电</strong>：住宿只要有普通插座就能慢充，县城也有快充站。纯电续航 100–200 公里，白天景点之间的短途基本能用纯电跑，油费还能再降一截。</li>
  <li><strong>别一直亏电跑</strong>：上高原前把电量留到 50% 以上 —— 长上坡时电机辅助输出，动力不衰减、也不额外费油。</li>
  <li><strong>取车时确认三件事</strong>：电量、随车充电枪、沿途充电桩位置（大理、丽江、香格里拉、德钦县城都有）。</li>
  <li>⚠️ 插混车<strong>同样有里程限制</strong>，「不限里程」套餐一样要选。</li>
</ul>
...
<table>
  ...
  <tr><td class="k">租车</td><td>租<strong>插混 SUV</strong>、提前订、选不限里程套餐；取车时拍视频留证并确认电量与随车充电枪</td></tr>
  <tr><td class="k">门票</td><td>丽江古城散客免费，只有黑龙潭需缴维护费；束河古镇免费</td></tr>
  <tr><td class="k">天气</td><td>出发前和当天早晨都看香格里拉、德钦的道路与天气</td></tr>
  <tr><td class="k">补给</td><td>D4 在德钦完成加油（<strong>云南段全程只需这一次</strong>）、饮水、食物和车辆检查</td></tr>
  <tr><td class="k">停车</td><td>海西生态廊道等区域不要把社会车辆开入禁止机动车路段</td></tr>
  <tr><td class="k">高原</td><td>住宿点海拔逐级升高：大理 2,050 m → 丽江 2,400 m → 香格里拉 3,280 m → 飞来寺 3,400 m，<strong>这样的顺序正好让身体逐步适应</strong>；香格里拉起就要留意高反，飞来寺清晨观景务必备好保暖层</td></tr>
...
`,
    pts: [
      { d: 1, n: "大理", lon: 100.23, lat: 25.59, alt: 2050, stay: "大理", pv: "530000" },
      { d: 2, n: "丽江", lon: 100.23, lat: 26.86, alt: 2400, stay: "丽江", pv: "530000" },
      { d: 3, n: "虎跳峡", lon: 100.11, lat: 27.19, alt: 1800, stay: null, pv: "530000" },
      { d: 3, n: "香格里拉", lon: 99.71, lat: 27.83, alt: 3280, stay: "香格里拉", pv: "530000" },
      { d: 4, n: "奔子栏", lon: 99.30, lat: 28.24, alt: 2000, stay: null, pv: "530000" },
      { d: 4, n: "飞来寺", lon: 98.88, lat: 28.48, alt: 3400, stay: "飞来寺", pv: "530000" },
      { d: 5, n: "大理", lon: 100.23, lat: 25.59, alt: 2050, stay: "大理", pv: "530000", back: 1 }
    ],
    people: 4,
    cost: { "住宿": 2700, "门票": 2050, "餐饮": 2500, "油费": 600, "租车": 2100, "停车": 300 },
    plan: [
    ...
    guides: [
      { area: "大理", note: "环线的起点与终点。海西一线是精华，古城本身反而适合早晚去逛。", items: [
        { n: "洱海西线（海西生态廊道）", fee: "免费", time: "半天",
          tips: [
            "<strong>社会车辆进不了廊道</strong> —— 只能停在外围停车场再步行或租自行车进入，别指望开车沿湖边逛。",
            "磻溪村的「S 弯」是网红机位，<span class=\"warn\">上午顺光</span>、人也最多；想拍空镜要 8:30 前到。",
            "廊道内租车约 ¥30–60 / 天（共享单车也有），骑到喜洲单程约 12 km。",
            "龙龛码头与才村码头是看洱海最方便的两个点，停车位少、早去。"
          ],
          route: { title: "海西半天走法（自驾 + 骑行）", stops: [
            { n: "龙龛码头", t: "08:30", d: "停车，看洱海" },
            { n: "才村码头", t: "09:30", d: "换骑/步行" },
            { n: "磻溪 S 弯", t: "11:00", d: "网红机位" },
            { n: "喜洲古镇", t: "12:30", d: "午餐 + 稻田" }
          ] } },
        { n: "大理古城", fee: "免费（崇圣寺三塔另计 ¥75）", time: "3–4 小时",
          tips: [
            "<strong>古城本身不收费</strong>，崇圣寺三塔在城外约 1.5 km，要单独买票。",
            "停车别往古城里挤 —— <span class=\"warn\">停南门外或东门外停车场</span>，¥10–20 / 次，进城全靠走。",
            "人民路上段比下段安静，小店更有意思；晚上洋人街一带最热闹。",
            "古城内客栈旺季贵、停车也难，住外围反而更划算。"
          ],
          route: { title: "古城半日步行线（南门进、北门出）", stops: [
            { n: "南门（正门）", t: "08:30", d: "城楼打卡" },
            { n: "复兴路", t: "09:00", d: "主街一路向北" },
            { n: "五华楼", t: "09:40", d: "登楼看古城" },
            { n: "人民路", t: "10:20", d: "小店与咖啡" },
            { n: "洋人街", t: "11:20", d: "酒吧街" },
            { n: "北门", t: "12:00", d: "出城返停车场" }
          ] } },
        { n: "喜洲古镇", fee: "免费（严家大院约 ¥30）", time: "2–3 小时",
          tips: [
            "比大理古城安静得多，商业化也轻，<strong>适合放在下午或傍晚</strong>。",
            "喜洲粑粑要买<strong>现做的</strong>（甜的是玫瑰糖、咸的是葱花肉），凉了就不好吃。",
            "稻田机位在镇东侧，10 月是金黄色；<span class=\"warn\">别踩进田里</span>，农户会拦。"
          ] }
      ] },

      { area: "丽江", note: "古城免费但别被维护费绕晕；束河比大研轻松，黑龙潭要单独缴维护费。", items: [
        { n: "丽江古城（大研）+ 木府", fee: "古城免费；木府约 ¥40", time: "4–5 小时",
          tips: [
            "<strong>散客进丽江古城本身免费</strong>，只有进黑龙潭才需要缴 ¥50 维护费（跟团才强制收）—— 别在古城门口买「维护费」。",
            "木府有<strong>免费官方讲解</strong>，跟着走能听懂纳西土司史；夜场票另约 ¥98。",
            "狮子山本身免费，登万古楼约 ¥30–35（可选），是俯瞰古城屋顶的最佳位置。",
            "古城内石板路多、台阶多，<span class=\"warn\">拉行李箱很痛苦</span>，客栈尽量选在古城边缘。"
          ],
          route: { title: "大研古城 + 木府一日线", stops: [
            { n: "大水车", t: "09:00", d: "古城标志" },
            { n: "四方街", t: "09:40", d: "中心广场" },
            { n: "木府", t: "10:30", d: "跟免费讲解" },
            { n: "光义街", t: "12:00", d: "午餐" },
            { n: "狮子山 · 万古楼", t: "14:00", d: "俯瞰古城" },
            { n: "黑龙潭", t: "15:30", d: "拍雪山倒影" }
          ] } },
        { n: "束河古镇", fee: "免费", time: "2–3 小时",
          tips: [
            "<strong>束河不收大门票</strong>，比大研安静，商业化程度低不少。",
            "停车在束河北门外；古镇内同样是石板路。",
            "离白沙古镇约 8 km，可以顺路去（白沙壁画约 ¥30）。"
          ] },
        { n: "黑龙潭公园", fee: "¥50（含古城维护费）", time: "1 小时",
          tips: [
            "拍<strong>玉龙雪山倒影</strong>的最佳机位在五孔桥，晴天上午几率最高。",
            "维护费在这里缴一次即可，古城内不再重复收。",
            "公园不大，<span class=\"warn\">专程为它跑一趟不太值</span>，顺路串在古城线里最合适。"
          ] }
      ] },

      { area: "香格里拉", note: "海拔 3,280 m 起，节奏放慢；纳帕海有季节性，别按宣传图预期。", items: [
        { n: "虎跳峡（上虎跳）", fee: "¥45", time: "2–2.5 小时",
          tips: [
            "<span class=\"warn\">中虎跳 / 下虎跳 2026 年起官方禁止进入</span>，只能看上虎跳。",
            "<strong>丽江段与香格里拉段门票不通用</strong> —— 导航请认准「香格里拉虎跳峡游客中心」，买错要重新买。",
            "观光电梯往返约 ¥80（自愿），走栈道下去也行，台阶较陡、上来喘。",
            "停车场到观景台有摆渡车，含在门票里。"
          ],
          route: { title: "上虎跳标准走法", stops: [
            { n: "游客中心", t: "09:30", d: "购票" },
            { n: "摆渡车", t: "09:50", d: "约 10 分钟" },
            { n: "上虎跳观景台", t: "10:10", d: "远观主激流" },
            { n: "江边栈道", t: "10:40", d: "下到江边" },
            { n: "返回", t: "11:40", d: "原路折返" }
          ] } },
        { n: "纳帕海 / 依拉草原", fee: "公共观景免费（骑马另计）", time: "1.5 小时",
          tips: [
            "<strong>它是季节性湖泊</strong>：6–8 月才是宣传图里「水漫草原 / 天空之镜」，<span class=\"warn\">10 月起水退成草甸</span>，别抱着看湖的期待。",
            "骑马<strong>一定先谈总价和时长</strong>，别跟路边拉客走；口碑差的马场不少。",
            "环湖公路约 30 km，自驾绕一圈 1.5 小时，沿途都是开阔草原。"
          ] },
        { n: "松赞林寺", fee: "约 ¥55–90（含讲解与观光车）", time: "1.5–2 小时",
          tips: [
            "云南规模最大的藏传佛教格鲁派寺院，「小布达拉宫」；<span class=\"warn\">殿堂内禁止拍照</span>，着装要遮肩遮膝。",
            "按<strong>顺时针</strong>转经、绕着殿堂走，别逆行。",
            "景区大门在公路上，必须换乘观光车进入（含在票里）。",
            "黄昏光线最好，金顶会发亮。"
          ],
          route: { title: "松赞林寺参观线（顺时针）", stops: [
            { n: "景区大门", t: "16:30", d: "换观光车" },
            { n: "扎仓大殿", t: "16:50", d: "主殿 · 禁拍照" },
            { n: "吉康殿", t: "17:20", d: "顺时针转" },
            { n: "转经道", t: "17:40", d: "转经筒长廊" },
            { n: "拉姆央措湖", t: "18:00", d: "拍全寺倒影" }
          ] } },
        { n: "普达措国家公园", fee: "¥138（含观光车；游船 ¥65 自愿）", time: "约 3 小时",
          tips: [
            "<strong>属都湖栈道约 4.4 km</strong>，海拔 3,500–4,150 m —— <span class=\"warn\">务必慢走</span>，喘了就停。",
            "<strong>10 月是层林尽染的最佳期</strong>，正是这条线的季节红利。",
            "游船能省一段步行，但另收费，且会错过栈道风景，建议不坐。",
            "湖边风大、温差大，外套一定要带。"
          ],
          route: { title: "普达措标准走法", stops: [
            { n: "门票站", t: "08:00", d: "购票入园" },
            { n: "观光车", t: "08:20", d: "约 20 分钟" },
            { n: "属都湖栈道", t: "08:50", d: "4.4 km 慢走" },
            { n: "弥里塘牧场", t: "10:20", d: "草甸秋色" },
            { n: "碧塔海", t: "10:50", d: "远观" },
            { n: "返回", t: "11:30", d: "观光车出园" }
          ] } }
      ] },

      { area: "德钦 · 梅里雪山", note: "全程最看天气的一段：日照金山是概率事件，点位和时间比器材重要。", items: [
        { n: "梅里雪山组合票（金沙江大湾 + 雾浓顶 + 飞来寺）", fee: "约 ¥150 / 人", time: "—",
          tips: [
            "三个点位<strong>买组合票更省事</strong>；只去其中一个的话，单买可能更便宜（大湾约 ¥20–60、飞来寺观景台约 ¥60）。",
            "<strong>住飞来寺的雪山观景房可以免掉飞来寺观景台的门票</strong> —— 房间天台就能看日照金山。",
            "三天内有效，别当天就用完。"
          ] },
        { n: "飞来寺 · 日照金山", fee: "含组合票（住观景房可免）", time: "清晨 1.5 小时",
          tips: [
            "<span class=\"warn\">日照金山不是保证项目</span> —— 云量和能见度决定效果，别把它当成「必看」。",
            "最佳窗口是<strong>10 月到次年 5 月的干季</strong>晴天；清晨 6:00–7:30 是观赏时间。",
            "海拔 3,400 m，清晨气温可到 -2 ℃ 以下，<strong>保暖层、手套、帽子</strong>都带上。",
            "拍日出建议长焦（70–200 mm）+ 三脚架；风大，脚架要挂重物压稳。"
          ],
          route: { title: "看金山的清晨流程", stops: [
            { n: "05:40", t: "起床", d: "看云图定计划" },
            { n: "06:00", t: "到天台", d: "占机位 · 架脚架" },
            { n: "06:30", t: "等光", d: "雪山由灰转金" },
            { n: "07:30", t: "收工", d: "回屋吃早餐" },
            { n: "08:30", t: "出发", d: "返程回大理" }
          ] } },
        { n: "雾浓顶观景台", fee: "含组合票", time: "30–45 分钟",
          tips: [
            "看梅里十三峰的正面机位，<strong>视野比飞来寺更完整</strong>（飞来寺偏侧）。",
            "从德钦县城上山约 10 km，山路窄、会车小心。",
            "<span class=\"warn\">清晨比飞来寺更冷</span>，风也更大。"
          ] },
        { n: "金沙江大湾 / 月亮湾", fee: "含组合票（单买约 ¥20–60）", time: "15–20 分钟",
          tips: [
            "观景台就在 214 国道旁，<strong>停车拍照十几分钟足够</strong>，不用多留。",
            "下午顺光，能看出江水的 Ω 形；上午逆光发灰。"
          ] },
        { n: "白马雪山（4292 垭口）", fee: "免费", time: "10–15 分钟",
          tips: [
            "垭口海拔 <strong>4,292 m</strong>，风大且冷，<span class=\"warn\">停车拍照别久留</span>。",
            "冬季偶有暗冰，过弯慢行；10 月以晴为主，风景最好的就是这段。"
          ] }
      ] }
    ]
  },
  ...
  /* ========================================================================
     旅游攻略（结构：导航进入 → 全屏密码门 → 全屏卡片墙 → 单篇三卡「正文 / 行程地图 / 数据报表」）
     扩展字段说明：
       region  标准地区名，须与 11 双向管理文件\地区词表.xlsx 的「标准地区名」一致
       pts     逐日行程点：[{d:第几天, n:地名, lon:经度, lat:纬度, alt:海拔米, stay:当晚住宿(无则 null)}]
                （alt 供数据报表显示「住宿点海拔」，>3000 m 会标朱红警示；
       ...
       guides  景点路书（单篇第 4 张卡）：按地区分组
               [{area:"地区名", note:"地区一句话提示(可省)", items:[
                  { n:"景点名", fee:"门票", time:"建议时长", tips:["避坑点1", ...],
                    route:{ title:"推荐走法", stops:[{n:"站点", t:"时间", d:"做什么"}] } }
               ]}]
               tips 支持 HTML（<strong> / <span class="warn">）；route 省略则不画路线图。
     ======================================================================== */
  {
...
![图片描述](https://example.com/image.png)</code></pre>
  ...
  },
  {
    ...
    shelf: "humanities",
    sub: "lit",
    summary: "第一人称与全知视角不是风格偏好，而是「你能知道什么」的边界设定 —— 视角是叙事里最有力的一件工具。",
    date: "2026-09-22",
    tags: ["文学", "叙事", "写作"],
    content: `
      <div class="callout">📌 这篇不分析某一本书，只讲一件工具：<strong>视角</strong>。它决定了读者能知道什么、又会误会什么。</div>
      <hr>
      <h2>一 · 视角决定「信息的边界」</h2>
      <p>第一人称只给你一个人的所见所想，所以<strong>误会在结构上不可避免</strong>：读者和叙述者被关在同一间屋子里，谁也不知道门外发生了什么。</p>
      <p>全知视角可以随时离开一个人，代价是<strong>悬念变难做</strong>——你什么都知道了，就不紧张了。所以悬疑小说几乎总是收窄视角。</p>
      <h2>二 · 不可靠叙述者</h2>
      <p>当叙述者本身有偏、有隐瞒、甚至神志不清，文本就出现了两层：<strong>表面上说出来的事实</strong>与<strong>背后暗示的真相</strong>。读这类书真正的乐趣，是学会不信任说话的那个人。</p>
      <h2>三 · 一个立刻可用的判据</h2>
      <p>读任何叙事时问一句：<strong>哪些事，是这个视角永远不可能知道的？</strong></p>
      <p>被排除掉的那部分，往往正是作者真正想让你自己去想的地方。</p>
      <h2>四 · 为什么值得带到生活里</h2>
      <p>每个人都在用第一人称讲自己，包括你复盘自己的时候。意识到<strong>\"我也是个可能有偏的叙述者\"</strong>，是从文学里能带走的最实用的一件东西。</p>
    `
  },
  {
    title: "历史不是事实的堆积，而是选择的结果",
    category: "知识文档",
    shelf: "humanities",
    sub: "hist",
    summary: "同一件事，三本书能写成三个样 —— 不是有人撒谎，而是记录本身就是一次取舍。",
    date: "2026-09-22",
    tags: ["历史", "史料", "方法"],
    content: `
      <div class="callout">📌 这篇不列年表，只讲一件事：<strong>史料是怎么被\"做\"出来的</strong>。</div>
      <hr>
      <h2>一 · 记录从落笔那一刻就开始变形</h2>
      <p>任何一次记录都要先回答三个问题：<strong>谁在记、记给谁看、漏掉什么代价最小</strong>。三个答案不同，同一件事就会长成不同的样子。</p>
      <p>最典型的例子是人口数字：古代户口册上的人数，往往是<strong>按征税需要折算过的</strong>，不是一个个数出来的。拿它去算经济总量，误差可以到几倍。</p>
      <h2>二 · 三种材料，三种可信边界</h2>
      <ul>
        <li><strong>实物</strong>（遗址、器物）：不会撒谎，但也不会说话——它不告诉你当时的人怎么想；</li>
        <li><strong>文书</strong>（档案、契约）：会说话，但说的永远是\"必须这么写\"的那一面；</li>
        <li><strong>叙述</strong>（史书、回忆录）：说得最多，也最需要看它省略了什么。</li>
      </ul>
      <p>三者互证才叫史料。只用其中一个来源，得到的往往不是历史，而是一份\"当时的说法\"。</p>
      <h2>三 · 一个可以马上用的习惯</h2>
      <p>看到任何一句历史结论，先反问：<strong>这条信息是谁、站在什么位置上、为了什么目的记下来的？</strong></p>
      <p>能不假思索答出来的，才是可以放心引用的。</p>
      <h2>四 · 为什么值得较这个真</h2>
      <p>不是因为要\"还原真相\"（多半也做不到），而是因为<strong>对材料保持警觉，是一种可以迁移到今天的思维方式</strong>——你每天读到的报表、新闻、复盘，同样是被人选择过的。</p>
    `
  },
  {
    title: "年表的用处与危险",
    ...
    shelf: "humanities",
    sub: "hist",
    summary: "时间线能看清因果的顺序，也会顺手抹掉「同一时刻还发生了什么」—— 两种读法要交替着用。",
    date: "2026-09-22",
    tags: ["历史", "时间线", "方法"],
    content: `
      <h2>一 · 年表擅长什么</h2>
      <p>它把事件排成一条线，于是\"谁先谁后、什么导致了什么\"变得可见。理解<strong>因果链</strong>时，年表是最好用的工具。</p>
      <h2>二 · 年表顺手隐去了什么</h2>
      <p>它把多面的过去压成一条线，于是<strong>同时性</strong>消失了：某地正乱成一团的那一年，另一处可能正在发生一件更重要的事，但年表只给了你一条线。</p>
      <p>更麻烦的是，<strong>事件的边界是人画的</strong>。\"某年某月某日，某事开始\"——这个日期通常是为了方便叙述才定下的，真实的变化往往持续了十几年。</p>
      <h2>三 · 三种尺度交替使用</h2>
      <ul>
        <li>想知道<strong>为什么</strong>：用年表，看顺序与因果；</li>
        <li>想知道<strong>当时的世界什么样</strong>：用横切面——同一年里各领域同时发生了什么；</li>
        <li>想知道<strong>变化怎么发生</strong>：用长时段——几十年到几百年尺度的气候、人口、技术。</li>
      </ul>
      <h2>四 · 放到自己身上</h2>
      <p>我们记自己的经历也是同一个毛病：能想起来的是几个\"节点\"，而节点之间的日常——那才是真正决定你变成谁的部分——在回忆里几乎是一片空白。</p>
    `
  },
  {
    title: "相关不等于因果：四种最常见的归因错误",
    category: "知识文档",
    shelf: "humanities",
    sub: "soc",
    summary: "混淆变量、反向因果、选择偏差、幸存者偏差 —— 四种看着都对、其实站不住的推理。",
    date: "2026-09-22",
    tags: ["社科", "统计", "思维"],
    content: `
      <div class="callout">📌 这四种错误每天都出现在报表、新闻和复盘里 —— 包括出现在你自己写的那一份里。</div>
      <hr>
      <h2>一 · 混淆变量</h2>
      <p>\"冰激凌卖得越多，溺水的人越多。\"两者确实高度相关，但真正的原因是<strong>气温</strong>——它同时推高了这两个数字。</p>
      <p>判据一句话：<strong>有没有第三个变量，能同时解释这两件事？</strong></p>
      <h2>二 · 反向因果</h2>
      <p>\"经常运动的人更少生病\" —— 也可能是因为<strong>本来就健康的人，才有余力去运动</strong>。因果的方向正好反过来。</p>
      <h2>三 · 选择偏差</h2>
      <p>只统计\"来健身房的人\"得出的结论，不能推广到所有人：那些没来的人，从一开始就不在样本里。</p>
      <p>它最常见的形态是<strong>幸存者偏差</strong>：统计返航飞机的弹孔分布，得出\"机翼中弹最多、所以要加固机翼\"——而真正的教训是\"发动机中弹的都没飞回来\"，那些飞机一架也没进样本。</p>
      <h2>四 · 一个够用的检查顺序</h2>
      <ul>
        <li>这两个变量之间，有没有第三个东西同时影响它们？</li>
        <li>方向会不会是反的？</li>
        <li>样本是怎么进来的？谁没进来？</li>
        <li>如果我错了，应该看到什么反例？</li>
      </ul>
      <h2>五 · 为什么要较真</h2>
      <p>不是为了做研究，而是因为<strong>归因错误会直接变成决策错误</strong>：把巧合当成规律，就是把资源押在小概率上。</p>
    `
  },
  {
    title: "问卷、访谈与参与式观察：三种方法各能回答什么",
    category: "知识文档",
    shelf: "humanities",
    sub: "soc",
    summary: "三种方法不是\"好坏的排序\"，而是各自只能回答某一类问题 —— 选错了，数据再漂亮也没用。",
    date: "2026-09-22",
    tags: ["社科", "研究方法", "调研"],
    content: `
      <h2>一 · 问卷：回答\"有多少\"</h2>
      <p>适合已经知道要问什么、只需要量化分布的问题（\"多少人这么想\"）。</p>
      <p>代价是：<strong>题目一旦写下，答案就被框住了</strong>。你问不到自己没想到的选项，也问不到\"为什么\"。</p>
      <h2>二 · 访谈：回答\"为什么\"</h2>
      <p>适合探索成因与逻辑（\"他为什么会这么判断\"）。能追问，也能发现预设之外的动机。</p>
      <p>代价是<strong>样本小、且不可避免受访问者影响</strong>——不能拿八个人的话去代表一群人。</p>
      <h2>三 · 参与式观察：回答\"实际怎么运转\"</h2>
      <p>进到现场待着，看人们真的在做什么。它最擅长揭穿一件事：<strong>人们说的和做的往往不一致</strong>。</p>
      <p>代价：进入现场本身就会改变现场；而且很慢。</p>
      <h2>四 · 怎么选</h2>
      <ul>
        <li>要<strong>分布</strong> → 问卷；</li>
        <li>要<strong>机制</strong> → 访谈；</li>
        <li>要<strong>实情</strong> → 观察。</li>
      </ul>
      <p>真正的调研常常三者一起用：先观察发现异常，再访谈找出原因，最后用问卷确认范围。</p>
    `
  },
  {
    title: "复利、贴现与机会成本",
    ...
    shelf: "humanities",
    sub: "fin",
    summary: "三个不需要金融知识就能用的算术 —— 它们改变的是判断本身，而不是算得快不快。",
    date: "2026-09-22",
    tags: ["财经", "决策", "常识"],
    content: `
      <h2>一 · 复利：时间比收益率更重要</h2>
      <p>每年 7%，大约十年翻一倍（72 法则：72 ÷ 年化收益率 ≈ 翻倍所需年数）。这条算式的重点是：<strong>决定结果的是时间长度，而不是你多努力地去找高收益</strong>。</p>
      <p>两个推论：<br>① 晚开始五年，很难靠提高收益率补回来；<br>② 复利同样作用于负债和坏习惯。</p>
      <h2>二 · 贴现：未来的钱要打折</h2>
      <p>一年后的 100 块，今天值多少？取决于你对\"等待\"的定价。把这件算清楚，很多\"听起来很划算\"的方案会立刻现原形：<strong>回本周期越长，越容易被高估</strong>。</p>
      <h2>三 · 机会成本：真正的成本是\"你没做的那个\"</h2>
      <p>花三小时比价省下五十块，成本不只是那三小时，而是<strong>这三小时本来能做成的另一件事</strong>。</p>
      <p>所以判断\"值不值\"时，问的不是\"这件事有没有收益\"，而是<strong>\"同样的资源放在别处，会不会更好\"</strong>。</p>
      <h2>四 · 三条合起来的用法</h2>
      <p>把时间当本金、把等待当成本、把没做的事算进价格 —— 三件事合起来，就是一份够用的决策纪律。</p>
    `
  },
  {
    title: "沉没成本与损失厌恶",
    ...
    shelf: "humanities",
    sub: "fin",
    summary: "已经花掉的钱不该影响下一步判断 —— 但人几乎做不到，原因在心理而不在算数。",
    date: "2026-09-22",
    tags: ["财经", "心理", "决策"],
    content: `
      <h2>一 · 沉没成本</h2>
      <p>已经付出、收不回来的成本，在理性决策里应该<strong>完全不参与</strong>下一步判断。做不做一件事，只看\"从现在往后\"的收益与代价。</p>
      <p>但\"我已经投入这么多了\"是世界上最难反驳的理由 —— 因为它讲的不是事实，是情绪。</p>
      <h2>二 · 损失厌恶</h2>
      <p>同样一百块，失去的痛苦大约是得到的两倍。于是：</p>
      <ul>
        <li>亏着的仓位舍不得割；</li>
        <li>读不下去的书硬要读完；</li>
        <li>用着难受的工具不肯换，因为\"当初学它花了两周\"。</li>
      </ul>
      <h2>三 · 一个可操作的问法</h2>
      <p>把问题重写一遍：<strong>如果我今天从零开始，还会选择这件事吗？</strong></p>
      <p>答案是否，那\"已经投入的\"就是沉没成本；答案是是，那它根本不需要用\"已经投入\"来辩护。</p>
      <h2>四 · 另一种解法：事先定规则</h2>
      <p>在情绪还没上来的时候写下退出条件（到什么程度就停），事后照做。<strong>规则要在冷静时定、在激动时用</strong> —— 顺序反了就失效。</p>
    `
  },
  {
    title: "苏格拉底式提问：把「我觉得」拆开",
    category: "知识文档",
    shelf: "humanities",
    sub: "phi",
    summary: "不提供答案，只把模糊的立场拆成可以检验的部分 —— 一种把「我觉得」变成清晰问题的技术。",
    date: "2026-09-22",
    tags: ["哲学", "提问", "思维"],
    content: `
      <h2>一 · 它到底在做什么</h2>
      <p>核心动作只有一个：<strong>把断言变成问题</strong>。\"这事不公平\" → \"你说的公平，指的是按什么分配？\"</p>
      <h2>二 · 四类常用问法</h2>
      <ul>
        <li><strong>澄清</strong>：你说的这个词，具体指什么？能举个例子吗？</li>
        <li><strong>追问理由</strong>：为什么这么认为？有没有反例？</li>
        <li><strong>换视角</strong>：如果从对方的位置看，会怎么描述这件事？</li>
        <li><strong>追问后果</strong>：如果照这个做，接下来会发生什么？</li>
      </ul>
      <h2>三 · 它不负责让你舒服</h2>
      <p>它的目标不是说服，而是<strong>让一个模糊的立场显形</strong>。所以它常常以\"我原来没想清楚\"结束——这不是失败，这正是它成功的样子。</p>
      <h2>四 · 用在自己身上</h2>
      <p>找一个你确信的判断，把它写成一句断言，然后逐条问上面四类问题。</p>
      <p><strong>能扛过这四轮的判断，才有资格进入决策</strong>；扛不过的，本来就只是情绪。</p>
    `
  },
  {
    title: "决定论与自由意志",
    ...
    shelf: "humanities",
    sub: "phi",
    summary: "一个两千多年没有答案的问题 —— 但它真正的用处不是给出答案，而是让「责任」这件事变得可说。",
    date: "2026-09-22",
    tags: ["哲学", "思辨", "责任"],
    content: `
      <div class="callout">📌 这篇不给结论。<strong>有些问题的价值不在答案，而在它让你以后用某些词时会犹豫一下。</strong></div>
      <hr>
      <h2>一 · 先把问题摆清楚</h2>
      <p>如果一切结果都由此前的原因决定，那么\"我本可以不这么做\"这句话还有意义吗？三种典型立场：</p>
      <ul>
        <li><strong>硬决定论</strong>：没有自由意志，\"责任\"是社会构造出来的；</li>
        <li><strong>自由意志论</strong>：人确实能做出不被此前原因决定的选择；</li>
        <li><strong>相容论</strong>：自由不等于\"没有原因\"，而等于\"没有外力在强迫我\"。</li>
      </ul>
      <h2>二 · 为什么相容论最常被现代人接受</h2>
      <p>因为它把自由重新定义为\"<strong>按自己的意愿行动，且这个意愿没有被胁迫</strong>\"。于是\"被决定\"与\"自由\"可以并存：你的选择有原因，但原因是<em>你自己</em>。</p>
      <h2>三 · 这个问题真正的产出</h2>
      <p>它不给你答案，但会逼你想清楚三件事：</p>
      <ul>
        <li>我所谓的\"自愿\"，到底指什么？</li>
        <li>在什么条件下，一个人可以不被追责？</li>
        <li>如果我的性格有一部分不是我选的，我该为它负责到什么程度？</li>
      </ul>
      <h2>四 · 允许它没有结论</h2>
      <p>以后再用\"责任\"\"自愿\"\"活该\"这些词时，如果会稍微犹豫一下 —— 那个犹豫就是收获。</p>
    `
  }
];
