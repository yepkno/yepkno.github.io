...
window.DOCS = [
  ...
  {
    title: "人文文库 · 试读：我们为什么会为一本书流泪",
    category: "知识文档",
    shelf: "humanities",
    summary: "一篇关于阅读与共情的短试读 —— 从这里能看到人文文库的排版与语气。",
    date: "2026-09-21",
    tags: ["人文", "阅读", "试读"],
    content: `
      <div class="callout">📌 这是人文文库的<strong>试读样章</strong>：内容与排版都在这里定型，之后的正式文章会沿用同一套语气。</div>
      <hr>
      <h2>一</h2>
      ...
      <h2>三</h2>
      <p>这也是这个文库为什么把人文单独放在一格、用红色标记的原因：</p>
      <ul>
      ...
      <hr>
      <p class="warn">⚠️ 本页为<strong>示例试读</strong>；正式文章上线后，这一篇会被替换或保留为"样章"。</p>
    `
  },
  {
    title: "馆藏原件总目",
